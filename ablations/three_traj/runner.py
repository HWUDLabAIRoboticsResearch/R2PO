...
from ablations.three_traj.linear_semantics_agent import (
    ReflectiveThreeTrajectoriesLinearSemanticsAgent,
)
from ablations.three_traj.q_table_semantics_agent import (
    ReflectiveThreeTrajectoriesQTableSemanticsAgent,
)
...
def run_training_loop(
    ...
    **_extra,
    ...
    assert task in [
        "dist_state_three_traj",
        "cont_state_three_traj",
    ]
    ...
    if task == "dist_state_three_traj":
        ...
        agent = ReflectiveThreeTrajectoriesQTableSemanticsAgent(
            logdir,
            dim_actions,
            dim_states,
            max_traj_count,
        ...
        agent = ReflectiveThreeTrajectoriesLinearSemanticsAgent(
            logdir,
            dim_actions,
            dim_states,
            max_traj_count,
