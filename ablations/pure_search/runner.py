...
from ablations.pure_search.linear_semantics_agent import (
    PureSearchLinearSemanticsAgent,
)
from ablations.pure_search.q_table_semantics_agent import (
    PureSearchQTableSemanticsAgent,
)
...
def run_training_loop(
    ...
    **_extra,
    ...
    assert task in [
        "dist_state_pure_search",
        "cont_state_pure_search",
    ]
    ...
    if task == "dist_state_pure_search":
        ...
        agent = PureSearchQTableSemanticsAgent(
            logdir,
            dim_actions,
            dim_states,
            max_traj_count,
        ...
        agent = PureSearchLinearSemanticsAgent(
            logdir,
            dim_actions,
            dim_states,
            max_traj_count,
