...
from ablations.actor_second_pass.linear_semantics_agent import (
    ActorSecondPassLinearSemanticsAgent,
)
from ablations.actor_second_pass.q_table_semantics_agent import (
    ActorSecondPassQTableSemanticsAgent,
)
...
def run_training_loop(
    ...
    **_extra,
    ...
    assert task in [
        "dist_state_actor_second_pass",
        "cont_state_actor_second_pass",
    ]
    ...
    if task == "dist_state_actor_second_pass":
        ...
        agent = ActorSecondPassQTableSemanticsAgent(
            logdir,
            dim_actions,
            dim_states,
            max_traj_count,
        ...
        agent = ActorSecondPassLinearSemanticsAgent(
            logdir,
            dim_actions,
            dim_states,
            max_traj_count,
    ...
    print("actor_second_pass init done")
