...
from ablations.reptraj.linear_semantics_agent import (
    ReflectiveLinearSemanticsAgent,
)
from ablations.reptraj.q_table_semantics_agent import (
    ReflectiveQTableSemanticsAgent,
)
...
def run_training_loop(
    ...
    **_extra,
    ...
    assert task in ["dist_state_reptraj", "cont_state_reptraj"]

    # Resolve logdir to run_N
    ...
    if task == "dist_state_reptraj":
        ...
        agent = ReflectiveQTableSemanticsAgent(
            logdir,
            dim_actions,
            dim_states,
            max_traj_count,
        ...
        agent = ReflectiveLinearSemanticsAgent(
            logdir,
            dim_actions,
            dim_states,
            max_traj_count,
