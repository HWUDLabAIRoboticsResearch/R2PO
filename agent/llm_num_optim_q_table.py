...
class LLMNumOptimQTableAgent:
    ...
    def train_policy(self, world: BaseWorld, logdir):
        ...
        def parse_parameters(input_text):
            # Parse across the full response because some models prepend/append prose.
            ...
            results = [indexed_results[i] for i in range(self.rank)]
            print(results)
